...
class Lana_Carousel_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$before_inner = '<div class="carousel-inner">';
		$after_inner  = '</div>';

		$before_image = '<div class="carousel-item %s">';
		$after_image  = '</div>';

		$carousel_image = '<div style="%s" class="carousel-image d-block w-100"></div>';

		$before_caption = '<div class="carousel-caption d-none d-md-block">';
		$after_caption  = '</div>';

		$before_caption_title = '<h5>';
		$after_caption_title  = '</h5>';
		...
		$control_prev = '<a class="carousel-control-prev" href="#%s" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                          </a>';

		$control_next = '<a class="carousel-control-next" href="#%s" role="button" data-slide="next">
