	...
	public function form( $instance ) {
        ...
        <p>
            ...
            <select name="<?php echo $this->get_field_name( 'type' ); ?>"
                ...
                <option value="alert-primary" <?php selected( $instance['type'], 'alert-primary' ); ?>>
					<?php esc_html_e( 'Primary', 'lana-widgets' ); ?>
                </option>
                <option value="alert-secondary" <?php selected( $instance['type'], 'alert-secondary' ); ?>>
                ...
                <option value="alert-light" <?php selected( $instance['type'], 'alert-light' ); ?>>
					<?php esc_html_e( 'Light', 'lana-widgets' ); ?>
                </option>
                <option value="alert-dark" <?php selected( $instance['type'], 'alert-dark' ); ?>>
